...
| app:concurrency:batch_max_active_executions         | APP__CONCURRENCY__BATCH_MAX_ACTIVE_EXECUTIONS            | 2             | Maximum number of intact batch GraphQL executions admitted concurrently in one backend process |
