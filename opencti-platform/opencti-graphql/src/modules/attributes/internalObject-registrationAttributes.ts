...
const internalObjectsAttributes: { [k: string]: Array<AttributeDefinition<any>> } = {
  [ENTITY_TYPE_SETTINGS]: [
    ...
    { name: 'platform_ip_whitelist', label: 'IP allow list', type: 'string', format: 'short', mandatoryType: 'no', editDefault: false, multiple: true, upsert: false, isFilterable: false },
    { name: 'platform_ip_whitelist_enabled', label: 'IP allow list enabled', type: 'boolean', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
    { name: 'platform_ip_whitelist_exclusion_ids', label: 'IP allow list exclusion IDs', type: 'string', format: 'id', entityTypes: [ENTITY_TYPE_USER, ENTITY_TYPE_GROUP, ENTITY_TYPE_IDENTITY_ORGANIZATION], mandatoryType: 'no', editDefault: false, multiple: true, upsert: false, isFilterable: false },
    ...
    { name: 'password_policy_validity_days', label: 'Password validity in days', type: 'numeric', precision: 'integer', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
    ...
    { name: 'smtp_configuration', label: 'SMTP configuration', type: 'object', format: 'flat', mandatoryType: 'no', editDefault: false, multiple: false, upsert: false, isFilterable: false },
  ],
  [ENTITY_TYPE_MIGRATION_STATUS]: [
  ...
  [ENTITY_TYPE_CONNECTOR]: [
    ...
    { name: 'enrichment_batch_capability', label: 'Enrichment batch capability', type: 'object', format: 'flat', mandatoryType: 'no', editDefault: false, multiple: false, upsert: true, isFilterable: false },
  ...
  [ENTITY_TYPE_BATCH_DELIVERY]: [
    ...
    { name: 'handoff_evidence', label: 'Batch delivery handoff evidence', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
    { name: 'child_set_fingerprint', label: 'Child set fingerprint', type: 'string', format: 'short', editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: false },
    { name: 'child_count', label: 'Child count', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'child_delivery_ids', label: 'Child delivery IDs', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: true, upsert: false, isFilterable: false },
    { ...createdAt, isFilterable: false },
    { ...updatedAt, isFilterable: false },
    { name: 'published_at', label: 'Published at', type: 'date', editDefault: false, mandatoryType: 'no', multiple: false, upsert: false, isFilterable: false },
  ...
  [ENTITY_TYPE_BATCH_EXECUTION_RESULT_STAGING]: [
    { name: 'staging_id', label: 'Staging ID', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
    { name: 'receipt_id', label: 'Receipt ID', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
    { name: 'delivery_id', label: 'Delivery ID', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
    { name: 'submission_id', label: 'Submission ID', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: true },
    { name: 'request_fingerprint', label: 'Request fingerprint', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'request_contract_version', label: 'Request contract version', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'result_version', label: 'Result version', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'operation_count', label: 'Operation count', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'operation_errors', label: 'Operation errors', type: 'object', format: 'flat', editDefault: false, mandatoryType: 'internal', multiple: true, upsert: false, isFilterable: false },
    { name: 'execution_mode', label: 'Execution mode', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'wait_until', label: 'Wait until', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
    { name: 'side_effect_kinds', label: 'Side effect kinds', type: 'string', format: 'short', editDefault: false, mandatoryType: 'internal', multiple: true, upsert: false, isFilterable: false },
    { name: 'serialized_bytes', label: 'Serialized bytes', type: 'numeric', precision: 'integer', editDefault: false, mandatoryType: 'internal', multiple: false, upsert: false, isFilterable: false },
