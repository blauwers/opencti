...
testCreatedCounter.relationship = 151;
testCreatedCounter.report = 42;
...
testCreatedCounter.vocabulary = VOCABULARY_NUMBERS + 4;
...
testUpdatedCounter.malware = 19;
testUpdatedCounter.file = 21;
...
testMergedCounter.artifact = 2;

export const testDeletedCounter: Record<string, number> = {};
testDeletedCounter.artifact = 6;
...
testDeletedCounter.vocabulary = 4;
